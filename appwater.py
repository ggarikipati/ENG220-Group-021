...
# Explanation for Sidebar
st.sidebar.info(
    "This sidebar lets you customize the charts displayed on the dashboard. You can select specific sites, thresholds, or top contributing regions."
)
...
thresh_info = st.sidebar.info(
    "This slider adjusts the threshold for identifying 'dry years' based on snow depth values."
)
threshold = st.sidebar.slider("Dry Year Snow Depth Threshold (in)", 0, 20, 10, key="threshold")
top_sites_info = st.sidebar.info(
    "This slider controls the number of top sites shown in the 'Top Sites with Greatest Resource Decline' chart."
)
...
# 5. Cumulative Snow Depth Over Time
...
# 6. Regional Resource Contribution
...
# 7. Snow Depth Variability Over Years
